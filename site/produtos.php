  ...
  <body>
    ...
    <div class="product-big-title-area">
		...
		<div class="container theme-showcase" role="main">
			...
			<div class="row">
				<?php while($rows = mysqli_fetch_assoc($resultado)){  //exibe os produtos
					...
					<div class="col-sm-6 col-md-4">
						<div class="thumbnail">
							...
							<div class="caption text-center">
								...
								<p><a href="detalhes.php?id_pagina=<?php echo $rows['id']; ?>" class="btn btn-primary" role="button">Ver Detalhes</a> </p>
							</div>
						</div>
					</div>
				<?php } ?>
